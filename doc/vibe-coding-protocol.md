...
| 07:24 UTC | 05:24 UTC | 07:42 UTC | 138m | feat: whisper large-v3-turbo model support | Check HW+cache; fix bot_voice.py cache-path for org/repo + turbo alias; mobiuslabsgmbh fallback; T81 test; bot.env updated; deployed+verified | 2 | 1 | claude-sonnet-4.6 | src/features/bot_voice.py, src/tests/test_voice_regression.py | done |
| 08:35 UTC | 07:45 UTC | 08:35 UTC | 50m | test: add T82-T92 RAG/memory/knowledge tests + gpt.md §11 changelog | Read gpt.md+TODO+DONE+sources+live DB; write 10 test functions T82-T92 (T87 skipped, covered by T60); fix test cases; run all; update gpt.md §8/§9/§11 with live status | 3 | 1 | claude-sonnet-4.6 | src/tests/test_voice_regression.py, doc/gpt.md | done |
| 09:24 UTC | 06:59 UTC | 09:24 UTC | 145m | deploy: push all changes + ts2 deploy + deploy script bug fix | git push 4 commits (turbo, gpt.md, T82-T92, §11 changelog); ts2 full deploy via taris_deploy.sh; fix false-positive FAIL_COUNT in smoke tests (grep 'FAIL 0' bug) | 1 | 1 | claude-sonnet-4.6 | src/setup/taris_deploy.sh | done |
